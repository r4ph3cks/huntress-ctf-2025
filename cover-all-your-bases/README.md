...
This warmup challenge requires to follow each representation and submit a flag.

### First Representation
**Description:** Uncover the appropriate plaintext and submit the flags below! Do you know what all these ones and zeros mean?
...
Using [CyberChef](https://cyberchef.io/) and a binary recipe, we got the following output with the flag:
...
**Description:** Hmmm, a group of triplets, it looks like. Can you find out what they are trying to say?
...
Again using [CyberChef](https://cyberchef.io/) we decoded Base 8 (octal). We got the following with the flag:
...
**Description:** These numbers look familiar... but how could they be represented as text?
...
Again [CyberChef](https://cyberchef.io/), our friend, , gave us the flag from base 10:
...
**Description:** These look like pairs! But these have weird letters in them?
...
[CyberChef](https://cyberchef.io/) is being abused at this point... We got the flag from hex:
...
**Description:** Uppercase letters and digits in a long stream.... notice anything about the padding?
...
Has [CyberChef](https://cyberchef.io/) gotten used to decoding simple stuff? Anyway, we got the flag:
...
**Description:** A mixed alphabet with symbols. What is this one supposed to be?
...
This one we needed to take out the ```\n``` from the string (yes it has WTF). We got the output from base 45:
...
**Description:** Compact and common on the wire... does the ending give you a clue?
...
Hello [CyberChef](https://cyberchef.io/)... Are you alright? We think he got used to this... Anyways we got the following from base 64:
...
**Description:** This variant often shows special markers. See anything bracketing the data?
...
[CyberChef](https://cyberchef.io/) doesnt want to talk to us. We got upset by the work he is having. Although he gave us the output from base base85, and also we got to take out the ```\n```:
...
**Description:** This noisy alphabet is picky about whitespace... formatting might matter!
...
[CyberChef](https://cyberchef.io/) is ingoring at this point and don't want to work with us anymore. We moved to [dCode](https://www.dcode.fr/en). From base 92 we got, without line breaks:
...
Yeah i it looks like chinese, anyways we used [BetterConverter](https://www.better-converter.com/Encoders-Decoders/Base65536-Decode) for this one. We investigated and there because of the characters we tried base 65536 and we got the following:
